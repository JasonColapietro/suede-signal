...
const BODY = `
Each check in the audit has a concrete fix. This page collects them with copy-pasteable examples, ordered by lane weight. Start at the top and the score moves fastest.
...
If you have no robots.txt, that's fine. Everything is allowed by default. Only add rules when you want to *restrict* something. And remember robots.txt is a request, not enforcement: it keeps honest crawlers out, nothing more.
  ...
  return (
    <article>
      ...
      <p className="mt-3 text-muted">
        Copy-pasteable fixes for each check in the audit, heaviest lanes first.
      </p>
      <div
