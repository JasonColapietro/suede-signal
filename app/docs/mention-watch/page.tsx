...
Each mention card has a "Draft a reply" button. The draft is a template, not AI-generated text, and it's built around three non-negotiables:
...
3. **No pressure close.** The draft ends by conceding a different tool might fit better. Sometimes it does, and saying so is what makes the rest credible.

The draft copies to your clipboard; nothing is posted on your behalf.

## Why do community threads matter for AI visibility?

Three reasons, boring and structural:
...
- Do not remove the disclosure line from a draft.
